...
{
    public class BranchRepository(AppDbContext appDbContext) : IGenerictRepositoryInterface<Branch>
    {
        ...
        {
            if (!await CheckName(item.Name)) return new(false, "Branch already created");
