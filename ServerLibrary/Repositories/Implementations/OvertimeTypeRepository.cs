...
{
    public class OvertimeTypeRepository(AppDbContext appDbContext) : IGenerictRepositoryInterface<OvertimeType>
    {
        public async Task<GeneralResponse> DeleteByID(int id)
        {
            var item = await appDbContext.OvertimeTypes.FirstOrDefaultAsync(eid => eid.Id == id);
        ...
        public async Task<OvertimeType> GetById(int id) => await appDbContext.OvertimeTypes.FirstOrDefaultAsync(eid => eid.Id == id);
