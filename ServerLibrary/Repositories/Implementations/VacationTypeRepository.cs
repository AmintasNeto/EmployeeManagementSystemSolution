...
{
    public class VacationTypeRepository(AppDbContext appDbContext) : IGenerictRepositoryInterface<VacationType>
    {
        public async Task<GeneralResponse> DeleteByID(int id)
        {
            var item = await appDbContext.VacationTypes.FirstOrDefaultAsync(eid => eid.Id == id);
        ...
        public async Task<VacationType> GetById(int id) => await appDbContext.VacationTypes.FirstOrDefaultAsync(eid => eid.Id == id);
